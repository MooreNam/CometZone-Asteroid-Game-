class Asteroid{
  ...
  public Asteroid(ArrayList<Asteroid> a, float m, PShape s, PVector p, PVector v,boolean willItHaveGravity, boolean dead){
    asteroids = a;
    asteroids.add(this);
    model = s;
    pos = p;
